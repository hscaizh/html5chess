...
GameManager.prototype.generateMoves = function(){
  return "1...Bxg2+ 2.Kxg2 Qxg4+ 3.Kh1 Qf3#";
};
...
GameManager.prototype.setup = function () {
  ...
  if(!this.fromFen(this.generateStartFen())){
    alert("fen error!");
    return false;
  }
  this.actuate();
...
GameManager.prototype.setLeagalMoves = function(moves){
...
GameManager.prototype.run = function(){
    ...
    var move = this.activePlayer.getMove();

    if (this.checkMove(move)){
      this.activePlayer.play();
      this.grid.move(move);
      this.actuator.showMove(move);
      this.switchPlayer();
      this.actuate();
    }
...
GameManager.prototype.checkOver = function(){
  return false;
};
